...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE Magy 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR Magy 🐈`}
...
//main.js
const smsWelcome = () => { return `*╭━〔 Magy Bot 💛 〕━⬣*\n*┃ Bienvenido Al Mejor Grupo De WhatsApp 👤*\n*┃ Nombre :* @subject\n*┃ Usuario Nuevo :* @user\n*╰━━━━━━━━━━━━⬣*`}
const smsBye = () => { return '*╭━〔 Magy Bot 💛 〕━⬣*\n*┃ Una Putita Menos En El Grupo 👤*\n*┃ Usuario :* @user\n*╰━━━━━━━━━━━━⬣*'}
const smsSpromote = () => { return '𝗬𝗮𝗹𝗹𝗶𝗰𝗼 𝗕𝗼𝘁 𝗟𝗲 𝗗𝗶𝗼 𝗘𝗹 𝗣𝗼𝗱𝗲𝗿 𝗗𝗲 𝗦𝗲𝗿 𝗔𝗱𝗺𝗶𝗻 𝗔 : @user '}
const smsSdemote = () => { return '𝗬𝗮𝗹𝗹𝗶𝗰𝗼 𝗕𝗼𝘁 𝗟𝗲 𝗤𝘂𝗶𝘁𝗼 𝗘𝗹 𝗣𝗼𝗱𝗲𝗿 𝗗𝗲 𝗦𝗲𝗿 𝗔𝗱𝗺𝗶𝗻 𝗔 : @user '}
...
//_allantilink.js
const smsTextoYT = () => { return '🧡 𝗕𝗼𝘁 𝗗𝗲 𝗠𝗮𝗴𝘆 💛'} 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar Magy`}
...
const smsContacto4 = () => { return 'Contacto Oficial de Magy 🐈'}
