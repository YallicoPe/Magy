...
await this.sendMessage(m.chat, { text: `𝙱𝚘𝚝 𝙳𝚎 𝙼𝚊𝚐𝚢 𝙰𝚗𝚞𝚗𝚌𝚒𝚊 𝚄𝚗 𝙽𝚞𝚎𝚟𝚘 𝙰𝚍𝚖𝚒𝚗 𝙴𝚗 𝙴𝚕 𝙶𝚛𝚞𝚙𝚘 💛\n\n𝙽𝚞𝚎𝚟𝚘 𝙰𝚍𝚖𝚒𝚗 : @${m.messageStubParameters[0].split`@`[0]}\n𝙻𝚎 𝙾𝚝𝚘𝚛𝚐𝚘 𝙰𝚍𝚖𝚒𝚗 : ${usuario}`, mentions: [`${m.sender}`,`${m.messageStubParameters[0]}`]/*, mentions: (await conn.groupMetadata(m.chat)).participants.map(v => v.id)*/ }, { quoted: fkontak })
} else if (m.messageStubType == 30) {
await this.sendMessage(m.chat, { text: `𝙱𝚘𝚝 𝙳𝚎 𝙼𝚊𝚐𝚢 𝙰𝚗𝚞𝚗𝚌𝚒𝚊 𝚄𝚗 𝙰𝚍𝚖𝚒𝚗 𝙼𝚎𝚗𝚘𝚜 𝙴𝚗 𝙴𝚕 𝙶𝚛𝚞𝚙𝚘 💛\n\n𝙰𝚍𝚖𝚒𝚗 𝙼𝚎𝚗𝚘𝚜 : @${m.messageStubParameters[0].split`@`[0]}\n𝙻𝚎 𝚀𝚞𝚒𝚝𝚘 𝙰𝚍𝚖𝚒𝚗 : ${usuario}`, mentions: [`${m.sender}`,`${m.messageStubParameters[0]}`]/*, mentions: (await conn.groupMetadata(m.chat)).participants.map(v => v.id)*/ }, { quoted: fkontak })
